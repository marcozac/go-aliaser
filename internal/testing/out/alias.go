...
func J(p1 int, p2 *string, p3 []string, p4 []*bool, p5 [2]string, p6 map[string]int, p7 chan int, p8 func(int) string, p9 any, p10 struct {
	...
	Foo() string
	pkg.L
}, p12 pkg.D, p13 *pkg.E, p14 []int, p15 [2]pkg.D, p16 map[pkg.D]pkg.E, p17 context.CancelCauseFunc, p18 json.Marshaler, p19 json_2.Foo, p20 ...*packages.Module) (int, any, *pkg.D, error) {
	return pkg.J(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20...)
}
